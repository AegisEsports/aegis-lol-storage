...
export type LeagueMatches = Selectable<LeagueMatchesTable>;
export type NewLeagueMatches = Insertable<LeagueMatchesTable>;
export type UpdateLeagueMatches = Updateable<LeagueMatchesTable>;
