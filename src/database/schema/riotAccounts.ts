...
export type RiotAccounts = Selectable<RiotAccountsTable>;
export type NewRiotAccounts = Insertable<RiotAccountsTable>;
export type UpdateRiotAccounts = Updateable<RiotAccountsTable>;
